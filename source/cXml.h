...
public:
    ...
    public:
		...
		warning: use newTag(), do not direct use Xml::Tag construction
		*/
        Tag(const std::shared_ptr<Xml> &xml_, const std::string::const_iterator &begin_) : begin_(begin_),
                                                                                           xml(xml_),
                                                                                           parent(),
                                                                                           name(),
                                                                                           content(),
                                                                                           attributes(),
                                                                                           children() {}
        Tag(const std::shared_ptr<Xml> &xml_, const std::string::const_iterator &begin_, const std::shared_ptr<Xml::Tag> &parent) : begin_(begin_),
                                                                                                                                    xml(xml_),
                                                                                                                                    parent(parent),
                                                                                                                                    name(),
                                                                                                                                    content(),
